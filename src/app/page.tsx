    ...
    <PageShell>
      ...
      <main className="flex flex-col items-center justify-center px-6 pt-20 pb-24">
        <Image
          ...
          priority
        />
        <h1 className="text-4xl md:text-6xl font-bold text-center mb-4 text-white tracking-tight">
          Kings Court Boston
        </h1>
        <p className="text-white/60 text-lg text-center mb-12 max-w-md font-light">
        ...
        <div className="grid md:grid-cols-3 gap-4 max-w-3xl w-full">
          <div className="bg-white/[0.08] backdrop-blur-xl rounded-2xl p-6 border border-white/[0.08] text-center">
            <div className="w-11 h-11 bg-white/10 rounded-xl flex items-center justify-center mb-4 mx-auto">
