        ...
        {loading ? (
          ...
          <>
                  ...
                  {featuredShows.map((show) => {
                    ...
                    return (
                      <Link href={`/admin/shows/${show.id}`} key={show.id}>
                        <div className="bg-white/[0.06] backdrop-blur-xl border border-white/[0.06] rounded-2xl p-5 hover:bg-white/[0.08] transition">
            ...
            <div className="grid grid-cols-3 gap-3 mb-6">
              <Link href="/admin">
                <div className="bg-white/[0.06] backdrop-blur-xl border border-white/[0.06] rounded-xl p-4 text-center hover:bg-white/[0.08] transition">
              ...
              <div className="bg-white/[0.06] backdrop-blur-xl border border-white/[0.06] rounded-xl p-4 text-center">
                ...
                <div className="space-y-1.5">
                  {pendingRequests.slice(0, 5).map((req) => (
                    <Link href={`/admin/shows/${req.shows?.id}`} key={req.id}>
                      <div className="bg-white/[0.06] backdrop-blur-xl border border-white/[0.06] rounded-xl p-3 hover:bg-white/[0.08] transition">
              ...
              {recentMembers.length > 0 ? (
                <div className="space-y-1.5">
                  {recentMembers.map((m) => (
                    <div
                      key={m.id}
                      className="bg-white/[0.06] backdrop-blur-xl border border-white/[0.06] rounded-xl p-3"
                    >
                      <div className="flex items-center justify-between">
                        <div>
