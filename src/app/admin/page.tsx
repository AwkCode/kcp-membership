      ...
      <div className="max-w-4xl mx-auto p-4">
        <div className="flex gap-3 mb-4">
          ...
          <a
            ...
            className="px-4 py-2.5 border border-white/10 rounded-xl text-sm text-white/60 hover:text-white hover:border-white/20 transition flex items-center gap-2 shrink-0"
          >
