...
function MemberLoginForm() {
  ...
  const redirect = searchParams.get("redirect") || "/members/account";
      ...
      <main className="min-h-screen flex flex-col items-center justify-center px-6">
        <div className="max-w-sm w-full bg-white/[0.04] rounded-2xl border border-kc-purple/10 p-8">
          <div className="text-center mb-6">
            ...
            <p className="text-white/40 text-sm">Access your membership card</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <p className="text-white/30 text-xs text-center">
              Not a member yet?{" "}
              <Link href="/join" className="text-white/60 underline">
                Join now
              </Link>
            </p>
