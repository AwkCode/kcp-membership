...
export default function Header() {
  ...
  return (
    <header className="w-full absolute top-0 z-50 header-glass border-b border-white/[0.15]">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-3 flex items-center justify-between">
        ...
        <nav className="flex items-center gap-4 sm:gap-6 text-sm font-medium text-white/80">
          ...
          <div className="relative" ref={dropdownRef}>
            ...
            {loginOpen && (
              <div className="absolute right-0 mt-2 w-36 bg-kc-purple-dark/95 border border-kc-purple/30 rounded-lg shadow-xl overflow-hidden">
                <Link
                  href="/members/login"
